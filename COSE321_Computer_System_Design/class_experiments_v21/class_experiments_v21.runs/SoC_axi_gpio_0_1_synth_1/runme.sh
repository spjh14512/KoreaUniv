...
HD_PWD='C:/Users/suhtw/Downloads/cose321_level_trigger/class_experiments_v21/class_experiments_v21.runs/SoC_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SoC_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SoC_axi_gpio_0_1.tcl
